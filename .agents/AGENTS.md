...
## Color Palette
The primary aesthetic is deep dark mode with a metallic gold accent.
* **Backgrounds**: `#000000` (Pure Black), `#0A0A0A` (Elevated Black), `#121212` (Card Background).
* **Text & Foreground**: `#EAEAEA` (Primary Text/Off-White), `#8A8A8A` (Muted/Secondary Text).
* **Brand Accent**: `#C6A36B` (Muted Gold). Used for highlights, accents, and the continuous marquee.

## Brand Motif: Circular Marquee Ribbon
* A continuous motion device consisting of rotating text: `"CONVOKE • FOR PEOPLE BUILDING THE FUTURE • "`
