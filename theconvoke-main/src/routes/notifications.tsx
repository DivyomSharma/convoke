...
export const Route = createFileRoute("/notifications")({
  head: () => ({ meta: [{ title: "Notifications — Convoke" }, { name: "description", content: "Activity from your spaces, people and opportunities." }] }),
            ...
            <li key={i} className="py-5 flex gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[14px]">
                  <Link to="/profile/$handle" params={{ handle: it.who.handle }} className="underline-link text-ink">{it.who.name}</Link>{" "}
