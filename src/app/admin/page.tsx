...
export default async function Admin() {
  ...
  const [
    ...
    prisma.space.count(),
    prisma.meet.count(),
    prisma.meet.count({ where: { startTime: { lte: new Date() }, endTime: { gte: new Date() } } }),
  ...
  const metrics = [
    ...
    { e: "Spaces", n: totalSpaces.toLocaleString(), d: "Spaces" },
    { e: "Live Meets", n: liveEvents.toLocaleString(), d: `Out of ${totalEvents}` },
