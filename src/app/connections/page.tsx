...
export default async function ConnectionsPage() {
  ...
  return (
    <div className="max-w-[800px] mx-auto py-12 px-5">
      <h1 className="text-2xl font-serif text-ink mb-8">Connections</h1>
      <div className="flex gap-4 border-b border-g3/60 mb-6 overflow-x-auto no-scrollbar">
        {["Following", "Followers", "Mutuals", "Organizations", "Spaces"].map((tab) => (
      ...
      <div className="text-[13px] text-g5">Your network is empty. Start connecting with builders!</div>
    </div>
  );
}
