  ...
  return (
    <Shell wide>
      <div className="max-w-[800px] mx-auto px-5 sm:px-8 py-16">
        ...
        <div className="eyebrow mb-2">Host a Space</div>
        <h1 className="serif text-5xl text-ink mb-10">Create Space</h1>
        
        <div className="p-8 border border-g3 rounded-xl bg-g1/30 text-center">
          <div className="text-[15px] text-g6 mb-4">Space creation wizard is currently being upgraded.</div>
          <p className="text-[13px] text-g5">Your permissions are verified. Please check back shortly to launch your space.</p>
        </div>
      </div>
    </Shell>
  );
