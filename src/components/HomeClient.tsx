...
export function HomeClient({ feedItems, featured }: HomeClientProps) {
  ...
  return (
    <div className="relative overflow-hidden">
      <section className="relative bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,.92)_0%,rgba(247,244,239,.98)_60%,#F7F4EF_100%)] px-5 pb-14 pt-14 sm:px-8 sm:pb-20 sm:pt-20 dark:bg-[#000]">
