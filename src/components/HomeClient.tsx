...
export function HomeClient({ feedItems, featured }: HomeClientProps) {
  ...
  return (
    <div className="relative overflow-hidden">
      <section className="relative px-5 pb-14 pt-14 sm:px-8 sm:pb-20 sm:pt-20 dark:bg-[#000]">
        <div className="pointer-events-none absolute inset-0 z-0 dark:hidden" style={{ background: "radial-gradient(circle at center, #ffffff 0%, var(--paper) 100%)" }} />
