  ...
  return (
    <div className="relative overflow-hidden">
      <section className="relative bg-paper px-5 pb-14 pt-14 sm:px-8 sm:pb-20 sm:pt-20 dark:bg-[#000]">
        <div className="pointer-events-none absolute inset-0 z-0 dark:hidden bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,.92)_0%,rgba(255,245,245,.98)_60%,#fff5f5_100%)]" />
