  ...
  return (
    <div className="relative overflow-hidden">
      <section className="hero-light-flat relative bg-paper px-5 pb-14 pt-14 sm:px-8 sm:pb-20 sm:pt-20 dark:bg-[#000]">
        ...
        <div className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,.92)_0%,rgba(247,244,239,.98)_60%,#f7f4ef_100%)] dark:hidden" />
